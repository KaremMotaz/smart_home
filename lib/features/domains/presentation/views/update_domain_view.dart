...
import 'package:smart_home/features/domains/presentation/widgets/update_domain/update_domain_bloc_listener.dart';
...
class UpdateDomainView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<UpdateDomainCubit>(
      create: (context) => UpdateDomainCubit(
        updateDomainRepo: getIt.get<UpdateDomainRepo>(),
